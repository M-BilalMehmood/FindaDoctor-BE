    ...
    async createPrescription(req, res) {
        try {
            ...
            if (!doctorName || !illnessType || !patientId) {
                return res.status(400).json({ message: 'Doctor name, illness type, and patient ID are required' });
            }
    ...
    async scheduleAppointment(req, res) {
        try {
            ...
            await emailService.sendAppointmentConfirmation(appointment.patient.email, {
                ...
                time: `${hours.toString().padStart(2, '0')}:${minutes.toString().padStart(2, '0')}`, // Format time
            });
